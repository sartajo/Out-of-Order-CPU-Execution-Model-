...
namespace ns3 { 
  ...
  */
  ...
  private:
    ...
    LSQ m_lsq; 
    ROB m_rob; 
    int m_pendingCompute; //number of instructions left in current trace line
    bool m_hasPendingMem; //is there a memory operation pending from current trace line
    ns3::CpuFIFO::ReqMsg m_pendingMemReq; //the LOAD/STORE from current trace line
